                ...
                <div className="relative w-full h-full rounded-2xl overflow-hidden">
                  {project.image ? (
                    ...
                    <div className="w-full h-full bg-[#161617] flex items-center justify-center">
                      <span className="text-[10px] font-mono text-gray-600 uppercase tracking-widest">Node_Offline</span>
                    </div>
                  )}
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="pt-5 border-t border-white/10">
                  <a
                    ...
                    className="inline-flex items-center gap-3 text-gray-300 font-bold text-[10px] tracking-[0.2em] uppercase group/link hover:text-cyan-400 transition-all w-full justify-between"
                  >
                    Execute Deployment
                    <span className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center group-hover/link:bg-cyan-400 group-hover/link:text-black group-hover/link:border-cyan-400 transition-all transform-gpu group-hover/link:rotate-45">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M7 17l10-10M17 17V7H7" /></svg>
                    </span>
                  </a>
                </div>
              </div>
